...
class Transaction(models.Model):
    ...
    crypto_symbol = models.CharField(max_length=10, blank=True)
    crypto_amount = models.DecimalField(max_digits=24, decimal_places=12, null=True, blank=True)
    crypto_rate_usd = models.DecimalField(max_digits=24, decimal_places=8, null=True, blank=True)
